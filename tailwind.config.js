...
export default {
  ...
  theme: {
  	extend: {
        ...
        // PaperSense Palette
        papersense: {
          'primary': 'hsl(var(--papersense-primary))', // Deep Navy
          'primary-foreground': 'hsl(var(--papersense-primary-foreground))',
          'secondary': 'hsl(var(--papersense-secondary))', // Soft Slate
          'secondary-foreground': 'hsl(var(--papersense-secondary-foreground))',
          'accent': 'hsl(var(--papersense-accent))', // Sky Blue
          'accent-foreground': 'hsl(var(--papersense-accent-foreground))',
        },
